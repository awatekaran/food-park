...
@section('content')
    <!--=============================
                        BREADCRUMB START
                    ==============================-->
    <section class="fp__breadcrumb" style="background: url('{{ asset('frontead/images/counter_bg.jpg') }}');">
    ...
    <!--=========================
                        ...
                        ==========================-->
    <section class="fp__signin" style="background: url('{{ asset('frontead/images/login_bg.jpg') }}');">
